...
def cat_scratch(images: list[BuildImage], texts, args):
    ...
    positions = [
        (245, 631), (245, 631), (158, 601), (141, 550), (141, 550),  # 1-5
        (141, 550), (141, 550), (141, 550), (141, 550), (141, 550),  # 6-10
    ]
