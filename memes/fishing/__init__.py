...
def fishing(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((100, 70)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (104, 89), (104, 89), (104, 89), (104, 89), (104, 89), # 1-5
        (104, 89), (104, 89), (104, 89),   # 6-8
    ]
...
add_meme(
    ...
    keywords=["钓鱼"],  # 搜索关键词
    date_created=datetime(2025, 8, 19),  # 创建日期
    date_modified=datetime(2025, 8, 19),  # 修改日期
)