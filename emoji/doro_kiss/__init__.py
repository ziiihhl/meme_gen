...
def doro_kiss(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((190, 160)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (65, 343), (65, 343), (65, 343), (65, 343), (65, 343),  # 1-5
        (65, 343), (65, 343), (65, 343), (65, 343),   # 6-9
    ]
...
add_meme(
    ...
    keywords=["桃乐丝亲","Doro亲","doro亲"],  # 搜索关键词
