...
def ignite(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((170, 170)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (35, 32), (35, 32), (35, 32), (35, 32), (35, 32),  # 1-5
        (35, 32), (35, 32), (35, 32), (35, 32), (35, 32),  # 6-10
        (35, 32), (35, 32), (35, 32), (35, 32), (35, 32),  # 11-15
        (35, 32), (35, 32), (35, 32), (35, 32), (35, 32),  # 16-20
        (35, 32),   # 21
