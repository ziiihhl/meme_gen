...
def capoo_take_sleep(images: list[BuildImage], texts, args):
    ...
    positions = [
        (1, 103), (1, 103), (1, 103), (1, 103), (1, 103),  # 1-5
        (1, 103), (1, 103), (1, 103), (1, 103), (1, 103),  # 6-10
        (1, 103), (1, 103), (1, 103), (1, 103), (1, 103),  # 11-15
        (1, 103), (1, 103), (1, 103), (1, 103), (1, 103),  # 16-20
        (1, 103), (1, 103), (1, 103), (1, 103), (1, 103),  # 21-25
        (1, 103), (1, 103), (1, 103),   # 26-27
    ]
...
add_meme(
    "capoo_take_sleep",  # 模板的唯一标识符
    capoo_take_sleep,  # 处理函数
    min_images=1,  # 需要的最小图片数量
    max_images=1,  # 需要的最大图片数量
    keywords=["咖波睡觉","睡觉"],  # 搜索关键词
    tags=MemeTags.capoo,
