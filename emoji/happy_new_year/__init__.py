...
def happy_new_year(images: list[BuildImage], texts, args):
    ...
    positions = [
        (103, 165), (103, 165), (103, 165), (103, 165),  # 1-4
    ]
    ...
    # 将所有帧保存为GIF，动图平均帧率: 0.07
    return save_gif(frames, 0.07)

add_meme(
    "happy_new_year",  # 模板的唯一标识符
    happy_new_year,  # 处理函数
    min_images=1,  # 需要的最小图片数量
    max_images=1,  # 需要的最大图片数量
    keywords=["新年好"],  # 搜索关键词
    date_created=datetime(2025, 9, 7),  # 创建日期
    date_modified=datetime(2025, 9, 7),  # 修改日期
)