...
def beg_foster_care(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((146, 130)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (72, 37), (72, 37), (72, 37), (72, 37), (72, 37),   # 1-5
        (72, 37), (72, 37), (72, 37), (72, 37), (72, 37),   # 6-10
        (72, 37), (72, 37), (72, 37),    # 11-13
    ]
