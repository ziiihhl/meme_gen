...
def kurogames_jinhsi_eat(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((135, 135)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (146, 343), (146, 343), (146, 343), (146, 343), (146, 343),  # 1-5
        (146, 343), (146, 343), (146, 343), # 6-8
    ]
...
add_meme(
    "kurogames_jinhsi_eat",  # 模板的唯一标识符
    kurogames_jinhsi_eat,  # 处理函数
