...
def palworld_chillet(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((216, 183)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (120, 87), (120, 87), (120, 87), (120, 87), (120, 87),  # 1-5
        (120, 87), (120, 87), (120, 87), (120, 87), (120, 87),  # 6-10
        (120, 87), (120, 87), (120, 87), (120, 87), (120, 87),  # 11-15
        (120, 87), (120, 87), (120, 87), (120, 87), (120, 87),  # 16-20
        (120, 87), (120, 87), (120, 87), (120, 87),  # 21-24
    ]
    ...
    # 将所有帧保存为GIF，帧间隔为0.02秒
    return save_gif(frames, 0.02)

add_meme(
    "palworld_chillet",  # 模板的唯一标识符
    palworld_chillet,  # 处理函数
