...
def kurogames_jinhsi_steamed_buns(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((192, 173)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (361, 367), (361, 367), (361, 367), (361, 367), (361, 367),  # 1-5
        (361, 367), (361, 367), (361, 367), (361, 367), (361, 367),  # 6-10
        (361, 367), (361, 367), (361, 367), (361, 367), (361, 367),  # 11-15
        (361, 367), (361, 367), (361, 367), (361, 367), (361, 367),  # 16-20
    ]
...
add_meme(
    "kurogames_jinhsi_steamed_buns",  # 模板的唯一标识符
    kurogames_jinhsi_steamed_buns,  # 处理函数
    min_images=1,  # 需要的最小图片数量
    max_images=1,  # 需要的最大图片数量
    keywords=["今汐小笼包"],  # 搜索关键词
