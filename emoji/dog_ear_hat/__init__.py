...
def dog_ear_hat(images: list[BuildImage], texts, args):
    ...
    user_head = images[0].resize((156, 118)).convert("RGBA") #.circle()
    
    # 初始化帧列表，用于存储每一帧图像
    frames: list[IMG] = []

    positions = [
        (66, 109), (66, 109), (66, 109), (66, 109), (66, 109),  # 1-5
        (66, 109), (66, 109), (66, 109), (66, 109), (66, 109),  # 6-10
        (66, 109), (66, 109),   # 11-12
    ]
